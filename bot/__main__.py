...
def info(update, context):
    ...
    info_string = f' 𝙷𝚊𝚒 {user.username}/n ✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {context.bot.name}/n✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: (𝚁𝚞𝚋𝚢 𝙼𝚊𝚝𝚑𝚎𝚠𝚜)[https://t.me/gDrive_linkz] 𝙿𝚈𝚃𝙷𝙾𝙽-𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼-𝙱𝙾𝚃/n✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹/n✯ 𝙳𝙰𝚃𝙰𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱/n✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄'
