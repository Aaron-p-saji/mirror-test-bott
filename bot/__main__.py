...
def info(update, context):
    ...
    info_string = f' 𝙷𝚊𝚒 {user.username}/n' \
                  f'✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {context.bot.name}/n' \
                  f'✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/gDrive_linkz>𝚁𝚞𝚋𝚢 𝙼𝚊𝚝𝚑𝚎𝚠𝚜</a>/n' \
                  f'𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚃𝙷𝙾𝙽-𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼-𝙱𝙾𝚃' \
                  f'✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹/n' \
                  f'✯ 𝙳𝙰𝚃𝙰𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱/n' \
                  f'✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄/n' \
                  f'✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v2.0/n'
